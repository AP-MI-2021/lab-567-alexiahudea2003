...
def test_adauga_obiect():
    lista = []
    lista = adauga_obiect("1", "tabla", "alba", 300, "sala", lista)
    ...
    assert get_locatie(get_by_id("1", lista)) == "sala"

def test_sterge_obiect():
    lista = []
    lista = adauga_obiect("1", "tabla", "alba", 300, "sala", lista)
    lista = adauga_obiect("2", "proiector", "suspendat", 700, "sala", lista)
...
def test_modifica_obiect():
    ...
    lista = modifica_obiect("1", "ceas", "digital", 100, "sala", lista)
    ...
    assert get_locatie(obiect_updatat) == "sala"

    lista = []
    lista = adauga_obiect("1", "tabla", "alba", 300, "sala", lista)
    lista = modifica_obiect("3", "ceas", "digital", 100, "sala", lista)
